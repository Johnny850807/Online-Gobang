...
public class GobangDTO {
    private Team turn;
    private Team winner;
    private String board;

    public GobangDTO(Team turn, Team winner, String board) {
        this.turn = turn;
        this.winner = winner;
        this.board = board;
    }
    ...
    public static GobangDTO project(Gobang gobang) {
        ...
        return new GobangDTO(colorToTeam(gobang.getTurn()),
